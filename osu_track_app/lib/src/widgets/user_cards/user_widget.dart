...
import 'user_search_widget.dart';
  ...
  Widget UserInfoWidget(context, User item) {
                  ...
                  Expanded(
                    child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 10.0,),
                          Image.asset('icons/flags/png/${item.countryCode
              ...
              children: [
                Column(children: [
                  Container(child: Image.asset(
                      'assets/icon_score_types/grade_ss_silver.png'),),
                  SizedBox(height: 5,),
                ...
                Column(children: [
                  Container(child: Image.asset(
                      'assets/icon_score_types/grade_s_silver.png'),),
                  SizedBox(height: 5,),
